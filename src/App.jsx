...
//                         </h1>
//                         <p className="text-xl mb-8 text-white/80 leading-relaxed">
//                           Transform your study habits with AI-powered focus
//                           tracking, distraction-free learning, and gamified
//                           productivity.
//                         </p>
//                         <div className="space-y-4">
//                           <div className="flex items-center gap-3">
...
//                             <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
//                             <span>
//                               Smart study analytics and progress tracking
//                             </span>
//                           </div>
//                           <div className="flex items-center gap-3">
//                             <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
...
//                           <p className="text-white/70 mt-2 text-sm">
//                             {isLogin
//                               ? 'Login to your productivity dashboard'
//                               : 'Create your OneFocus account'}
//                           </p>
//                         </div>
//                         {isLogin ? (
//                           <NexusAuth onToggle={() => setIsLogin(false)} />
//                         ) : (
//                           <Register onToggle={() => setIsLogin(true)} />
//                         )}
//                       </div>
...
//                 <Route path="/compete" element={<Compete currentUser={user} />} />
